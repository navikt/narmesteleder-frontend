...
export type TokenValidationResult = { success: true; token: string } | { success: false; reason: string }

export const validateIdPortenToken = cache(async (): Promise<TokenValidationResult> => {
